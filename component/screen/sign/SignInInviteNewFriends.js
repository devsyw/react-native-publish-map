...
export default function SignInInviteNewFriends({navigation, route, options, back}){
    ...
    const renderItem = ({item}) => (
        <View style={{flex : 1, flexDirection : 'row'}}>
            ...
            <View style={styles.renderItem_bottom}>
                <TouchableOpacity style={styles.renderItem_bottom_letter}>
                    <AntDesign name="mail" size={moderateScale(20)} color="blue" />
                </TouchableOpacity>
            </View>
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.topArea}>
                ...
                <View style={styles.topArea_top}>
                    <Text style={styles.topArea_top_txt}>새로운 친구들을 불러보세요!</Text>
                </View>
            ...
            <View style={styles.bottomArea}>
                {/** 다음 페이지 이동 버튼 */}
                <TouchableOpacity
                    onPress={() => navigation.push('SignComplete')} //테스트용
